...
TRAILS = [
    ...
    (6032965,  "it-hike", 20, "national", "Cammino del beato Enrico"),
    (3446664,  "it-hike", 21, "national", "Il Cammino di Sant'Antonio"),
    (10275750, "it-hike", 22, "national", "Il Cammino di Sant'Antonio (Gemona - Padova)"),
    (20388719, "it-hike", 23, "national", "Cammino del Lago Maggiore"),
    (16907774, "it-hike", 24, "national", "Cammino di Don Tonino"),
    (13836647, "it-hike", 25, "national", "Cammino del Beato Claudio"),
    (7132092,  "it-hike", 26, "national", "Sentiero Lago di Lugano"),
    (15904861, "it-hike", 27, "national", "Cammino di San Giacomo - Da Caltagirone a Capizzi"),
    (15737206, "it-hike", 28, "national", "Cammino di Santu Jacu del Nord"),
    (7401588,  "it-hike", 29, "national", "Sentiero Italia - Abruzzo"),
    (7220974,  "it-hike", 30, "national", "Sentiero Italia - Molise"),
    (1706143,  "it-hike", 31, "national", "Alta Via n. 1 della Valle d'Aosta"),
    (11156760, "it-hike", 32, "national", "Cammino di San Jacopo"),
    (18730553, "it-hike", 33, "national", "Via degli Abati"),
    (15955535, "it-hike", 34, "national", "Tour del Parco Alpi Liguri"),
    (9527949,  "it-hike", 35, "national", "Viae Misericordiae"),
    (19542924, "it-hike", 36, "national", "Regio Tratturo Magno"),
    (222322,   "it-hike", 37, "national", "Via degli Dei"),
    (12636375, "it-hike", 38, "national", "Via della Lana e della Seta"),
    (17654925, "it-hike", 39, "national", "Via Fabaria Iblea"),
    (19561857, "it-hike", 40, "national", "Via Lucana"),
    ...
    (1673983,  "se-hike", 13, "national", "Hallandsleden"),
    (297037,   "se-hike", 14, "national", "Blekingeleden"),
    (254324,   "se-hike", 15, "national", "Södra Kungsleden"),
    (3199983,  "se-hike", 16, "national", "Tjustleden"),
    (3649216,  "se-hike", 17, "national", "Ostkustleden"),
    (8436154,  "se-hike", 18, "national", "Ingegerdsleden"),
    ...
    (5620490,  "no-hike", 4, "national", "Jotunheimstien"),
    (14770011, "no-hike", 5, "national", "Signatur Stølsheimen"),
    (14769947, "no-hike", 6, "national", "Signatur Omveien"),
    (14772116, "no-hike", 7, "national", "Signatur Trollheimen"),
    (14772110, "no-hike", 8, "national", "Signatur Lysefjorden rundt"),
    (14772117, "no-hike", 9, "national", "Signatur Helt på grensen"),
    (14772111, "no-hike", 10, "national", "Gullruta i Etnefjellene"),
    ...
    (11116577, "lv-hike", 2, "continental", "E11 Mežtaka"),

    # Estonia (ee-hike — add to Supabase CHECK before --import)
    (9645763,  "ee-hike", 1, "continental", "Euroopa matkarada E9"),
